...
public class MaterialTipDialog extends BaseDialog {
     ...
     */
    private DialogOneBtnClick dialogOneBtnClick;
    ...
    public boolean setUiBeforShow() {
        ...
        tv_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dialogOneBtnClick != null) {
                    dialogOneBtnClick.onBtnClick();
                } else {
                    dismiss();
                }
            }
     ...
     *
     * @param dialogOneBtnClick
     */
    public void setOnBtnClickL(DialogOneBtnClick dialogOneBtnClick) {
        this.dialogOneBtnClick = dialogOneBtnClick;
    }
