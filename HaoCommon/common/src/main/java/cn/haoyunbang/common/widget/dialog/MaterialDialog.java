package cn.haoyunbang.common.widget.dialog;
...
import cn.haoyunbang.common.widget.dialog.base.BaseDialog;
import cn.haoyunbang.common.widget.dialog.callback.DialogTwoBtnClick;
import cn.haoyunbang.common.widget.dialog.util.CornerUtils;
...
public class MaterialDialog extends BaseDialog {
     ...
     * 按钮点击事件回调
     */
    private DialogTwoBtnClick dialogTwoBtnClick;
    ...
    public boolean setUiBeforShow() {
        ...
        tv_btn_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dialogTwoBtnClick != null) {
                    dialogTwoBtnClick.leftBtnClick();
                }
            }
        });
        ...
        tv_btn_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dialogTwoBtnClick != null) {
                    dialogTwoBtnClick.rightBtnClick();
                }
            }
        });
     ...
     *
     * @param dialogTwoBtnClick
     */
    public void setOnBtnClick(DialogTwoBtnClick dialogTwoBtnClick) {
        this.dialogTwoBtnClick = dialogTwoBtnClick;
    }
    /**
